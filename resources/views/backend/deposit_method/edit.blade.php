					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="file" class="form-control dropify" name="image" data-default-file="{{ $depositmethod->image != null ? asset('public/uploads/media/'.$depositmethod->image) : smart_asset('backend/images/no-image.png') }}">
							</div>
						</div>
