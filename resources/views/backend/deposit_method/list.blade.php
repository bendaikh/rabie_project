				...
				<table id="deposit_methods_table" class="table table-bordered data-table">
					...
					<tbody>
					    ...
					    <tr data-id="row_{{ $depositmethod->id }}">
							<td class='image'><img class="thumb-sm" src="{{ $depositmethod->image != null ? asset('public/uploads/media/'.$depositmethod->image) : smart_asset('backend/images/no-image.png') }}"/></td>
