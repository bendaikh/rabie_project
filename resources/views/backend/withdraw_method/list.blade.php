				...
				<table id="withdraw_methods_table" class="table table-bordered data-table">
					...
					<tbody>
					    ...
					    <tr data-id="row_{{ $withdrawmethod->id }}">
							<td class='image'><img class="thumb-sm" src="{{ $withdrawmethod->image != null ? asset('public/uploads/media/'.$withdrawmethod->image) : smart_asset('backend/images/no-image.png') }}"/></td>
