					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="file" class="form-control dropify" name="image" data-default-file="{{ $withdrawmethod->image != null ? asset('public/uploads/media/'.$withdrawmethod->image) : smart_asset('backend/images/no-image.png') }}">
							</div>
						</div>
