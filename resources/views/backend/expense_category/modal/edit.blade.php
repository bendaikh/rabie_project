<link href="{{ smart_asset('backend/plugins/bootstrap-colorpicker/bootstrap-colorpicker.min.css') }}" rel="stylesheet">
...
<script src="{{ smart_asset('backend/plugins/bootstrap-colorpicker/bootstrap-colorpicker.js') }}"></script>
