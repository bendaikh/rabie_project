...
if (!function_exists('smart_asset')) {
    function smart_asset($path) {
        // Remove any existing public/ prefix from the path
        $path = preg_replace('/^public\//', '', $path);
        
        // Use Laravel's built-in asset() function which respects ASSET_URL
        return asset($path);
    }
}
...
if (!function_exists('get_logo')) {
    function get_logo() {
        ...
        if ($logo == "") {
            return smart_asset("backend/images/company-logo.png");
        }
        return smart_asset("uploads/media/$logo");
    }
}
...
if (!function_exists('get_favicon')) {
    function get_favicon() {
        ...
        if ($favicon == "") {
            return smart_asset("backend/images/favicon.png");
        }
        return smart_asset("uploads/media/$favicon");
    }
}
...
if (!function_exists('profile_picture')) {
    function profile_picture($profile_picture = '') {
        ...
        if ($profile_picture == '') {
            return smart_asset('backend/images/avatar.png');
        }

        return smart_asset('uploads/profile/' . $profile_picture);
    }
}
