...
Route::group(['middleware' => ['install']], function () {
    ...
    Route::group(['middleware' => ['auth', 'verified']], function () {
        ...
        Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
            ...
            //return
            Route::get('members-negative_balance', [MemberController::class, 'member_negative_balance'])->name('members.negative_balance');
...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin'], function () {
    Route::get('transactions/single-pdf/{id}', 'TransactionController@singlePDF')->name('transactions.single_pdf');
    Route::get('transactions/export-pdf', 'TransactionController@exportPDF')->name('transactions.export_pdf');
});

Route::get('members/{id}/pdf', 'MemberController@generatePDF')->name('members.pdf');